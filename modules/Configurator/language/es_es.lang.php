...
'LBL_MAILMERGE_DESC'                               => 'Esta opción debería marcarse sólo si tiene el complemento Sugar para Microsoft® Word®.',
'LBL_MAILMERGE'                                    => 'Combinar Correspondencia',
'LBL_MIN_AUTO_REFRESH_INTERVAL'                    => 'Mínimo intervalo de actualización automática del Dashlet',
'LBL_MIN_AUTO_REFRESH_INTERVAL_HELP'               => 'Este es el valor mínimo que uno puede elegir que  auto-actualice los dashlets. Ajuste a "nunca" para desactivar la  auto-restauración de dashlets por completo.',
...
'LBL_DISALBE_CONVERT_LEAD'                         => 'Desactivar la acción principal para convertir pistas convertidas',
'LBL_DISALBE_CONVERT_LEAD_DESC'                    => 'Si un conductor se ha convertido ya, si activa esta opción eliminará la acción principal de conversión.',
'LBL_ENABLE_ACTION_MENU'                           => 'Muestra las acciones dentro de los menús',
'LBL_ENABLE_ACTION_MENU_DESC'                      => 'Seleccione esta opción para mostrar la vista Detalle y acciones subpanel dentro de un menú desplegable. Si esta opción no seleccionado, las acciones se muestran como botones independientes.',
...
'NEW_LOGO_HELP'                                    => 'El formato de archivo de imagen puede ser cualquiera. Png o jpg.. La altura máxima es de 17px, y la anchura máxima es de 450px. Cualquier imagen cargada que es más grande en cualquier dirección será modificada para que estas dimensiones máx.',
'NEW_LOGO_HELP_NO_SPACE'                           => 'El formato de archivo de imagen puede ser cualquiera. Png o jpg.. La altura máxima es de 17px, y la anchura máxima es de 450px. Cualquier imagen cargada que es más grande en cualquier dirección será modificada para que estas dimensiones máx. Nombre de archivo de imagen no debe contener un carácter de espacio.',
...
'SHOW_DOWNLOADS_TAB'                               => 'Visualizar pestaña de descargas',
'SHOW_DOWNLOADS_TAB_HELP'                          => 'Visualizar pestaña de ayuda de descargas',
...
'LBL_LEAD_CONV_OPTION'                             => 'Guía de opciones de conversión',
'LEAD_CONV_OPT_HELP'                               => '<b> Copiar </ b> - Crea y relaciona las copias de todas las actividades de la Guía para los nuevos registros que se han seleccionado por el usuario durante la conversión. Las copias se crean para cada uno de los registros seleccionados <b> Move </ b> -. Mueve todas las actividades de la Guía para un nuevo disco que es seleccionado por el usuario durante la conversión <b> No hacer nada </ b> -. No hace nada con las actividades de la Guía durante la conversión. Las actividades permanecen relacionada con la única pista.',
...
'LBL_IMPORT_MAX_RECORDS_HELP'                      => 'Especifique el número de filas se permiten dentro de los archivos de importación. Si el número de filas <br> en un archivo de importación supera este número, el usuario será alertado. Si no se introduce <br> número, un número ilimitado de filas están permitidos.',
...
'LBL_YAHOO_MAIL'                                   => 'Logo de Yahoo',
'LBL_EXCHANGE_LOGO'                                => 'Logo de Exchange',
